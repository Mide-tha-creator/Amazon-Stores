...
import { getRecentAnalyticsWindow, getStoreAnalyticsAnchorEnd } from "@/lib/store/recent-analytics-window";
          ...
          <TabsContent value="kpi" className="space-y-6 rounded-lg border bg-white p-6">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2 sm:col-span-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Shown in Amazon top navigation. Stored for consistency across admin
                  and dashboard headers.
                </p>
